...
function OnRenderImage (source : RenderTexture, destination : RenderTexture) : void
{
	...
	var texBlur = oddEven ? buffer : buffer2;
	
	compositeMat.SetTexture ("_BlurTex", texBlur);
	//compositeMat.SetTextureOffset("_BlurTex",tOffset);
	compositeMat.SetTexture ("_ColorRamp", colorRamp);
	//compositeMat.SetTextureOffset("_ColorRamp",tOffset);
	compositeMat.SetTexture ("_BlurRamp", blurRamp);
	//compositeMat.SetTextureOffset("_BlurRamp",tOffset);
